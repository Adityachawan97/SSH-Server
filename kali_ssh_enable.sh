#This script will cover the startup of ssh server on the Kali Linux box
...
#Step2
#Backing up the old ssh default keys into a new seperate directory
echo " "
echo " "
echo " "
echo "***********************************************************************"
...
echo "Just type 'nano /etc/ssh/sshd_config' on your terminal window to open the file using the nano editor. "
echo "Given below are the lines that you need to edit in the configuration file: "
echo "All of these lines need to be uncommented for this to work. "
echo "Match the lines exactly as below to the lines in your sshd_config file leaving the rest to default"
